...
int ballquery_batch_p(at::Tensor xyz_tensor, at::Tensor batch_idxs_tensor,
                      at::Tensor batch_offsets_tensor,
                      at::Tensor adj_mat_inst_tensor,
                      float similarity_threshold_inst,
                      at::Tensor adj_mat_para_tensor,
                      float similarity_threshold_para,
  ...
  const float *adj_mat_inst = adj_mat_inst_tensor.data_ptr<float>();
  const float *adj_mat_para = adj_mat_para_tensor.data_ptr<float>();
