...
#define MAX_PRIMARY_NUM 6000
#define MAX_PER_PRIMARY_ABSORB_FRAGMENT_NUM  1000//1000
#define INFINITY_DIS_SQUARE 10000//0.8
#define MAX_PER_PRIMARY_ABSORB_POINT_NUM 3000//3000
...
__global__ void fragment_find_primary_(int primary_num, int *cuda_primary_offsets, float *cuda_primary_centers,
    ...
    float r_size = 0.01* sqrt(float(primary_point_num));//0.01
