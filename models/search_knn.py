...
from models.pointnet2_ops_lib.pointnet2_ops.pointnet2_utils import grouping_operation as group_point
...
def group_points(group_size, point_cloud, query_cloud, point_features=None):
